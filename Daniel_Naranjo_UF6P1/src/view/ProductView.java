...
public class ProductView extends javax.swing.JDialog {
    ...
    public void addProductView() {
        if (shop.isInventoryFull()) {
            JOptionPane.showMessageDialog(this, "El inventario está lleno", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (!product) {
            ...
            shop.inventory.add(new Product(name, new Amount(wholesalerPrice, "â‚¬"), true, stock));
            shop.numberProducts++;
